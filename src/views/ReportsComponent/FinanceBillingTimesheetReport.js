...
import { getTableData } from "./FinanceBillingTimesheetReportTable";
import FlatPrimeReactTable from "../PrimeReactTableComponent/FlatPrimeReactTable";

function FinanceBillingTimesheetReport() {
      ...
      <div className="col-md-12">
        <div className="pageTitle">
          ...
          <div className="childTwo">
            <h2>Finance Billing Timesheet Report</h2>
          </div>
...
export default FinanceBillingTimesheetReport;
