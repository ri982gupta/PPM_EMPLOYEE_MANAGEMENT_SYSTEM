...
function ProfileUtilisation(props) {
  const {
    selecredResId,
    value,
    visibleProp,
  ...
  const initialValue = {
    ...
    customerId: "-1",
    projectId: "-1",
    resourceId: value === "Teams" ? resDtl : "-1",
    pmId: "-1",
  ...
  let currentScreenName =
    value === "Teams"
      ? ["Insights", "Utilisation Dashboard"]
      : ["Allocation Dashboard"];
  let textContent = value === "Teams" ? "Teams" : "Dashboards";
  ...
  const getMenus = () => {
    axios({
      ...
      console.log(resp.data[0].subMenus[2].url_path);

      const urlPathValue = resp.data[0].subMenus[2].url_path;
    ...
    <div>
      ...
      <div className="group mb-3 customCard">
        ...
        <CCollapse visible={!visible}>
          <div className="group-content row">
            ...
            dataAccess == 700
              ? ""
              : (selectType == "bu" || selectType == "customer") &&
                value != "Teams" && (
                  <div className="col-md-3 mb-2">
                    <div className="form-group row">
            ...
            {value != "Teams" && selectType == "customer" ? (
              <div className="col-md-3 mb-2">
                <div className="form-group row">
                  <label className="col-4" htmlFor="email-input">
            ...
            {value != "Teams" && selectType == "project" ? (
              <div className="col-md-3 mb-2">
                <div className="form-group row">
                  <label className="col-4" htmlFor="email-input">
            ...
            {value != "Teams" && selectType == "resource" ? (
              <div className="col-md-3 mb-2">
                <div className="form-group row">
                  <label className="col-4" htmlFor="email-input">
            ...
            {value != "Teams" && selectType == "primaryPm" ? (
              <div className="col-md-3 mb-2">
                <div className="form-group row">
                  <label className="col-4" htmlFor="email-input">
                ...
                <div className="form-group row">
                  ...
                  <div className="col-2 pl-1 pr-0">
                    <select
                      id="operator"
                      className={
                        selectFilter == -1 ? "disabledFieldStyles" : ""
                      }
      ...
      <div className="col-12 p-0">
        <div
          className={
            value != "Teams"
              ? "col-12 row mr-0 pr-0"
              : "col-12 row mr-0 pr-0 mb-3"
          }
        >
          {msg && (
...
export default ProfileUtilisation;
