...
import './ExpensesMyRequests.scss'
...
function ExpensesMyRequest(props) {
  ...
  document.documentElement.style.setProperty(
    "--dynamic-value",
    String(props.maxHeight1-144 ) + "px"
  );
  ...
  const rowExpansionTemplate = (data) => {
    return (
      <div className="darkHeader ExpensesMyRequests-second-table">
        {loaderOne ? "" : ""}
  ...
  return (
    <div>
      <div className="customCard">
        ...
        {table == true ? (
          <div className="darkHeader ExpensesMyRequests">
            <DataTable
              value={data}
              showGridlines
              className="primeReactDataTable"
