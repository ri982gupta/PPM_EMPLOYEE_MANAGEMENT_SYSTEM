...
function ProjectsTable(props) {
  ...
  const renderHeader1 = () => {
    return (
      <div className="legend-Container-export-btn-wrapper">
  ...
  return (
    <div>
      <div className="darkHeader customer-projects-table">
